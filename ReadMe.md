...
3.  API to list, add, update and delete
1.  Test API <!--with Postman/Insomnia-->
1.  React Components <!--from static html-->
...
1.  API Client - front end
1.  Thunk Actions to get task from the API 
1.  Redux Actions to save task data from the API <!--(remove hard-code initialState)-->
